...
const local: App.I18n.Schema = {
  ...
  custom: {
    ...
    devicePage: {
      ...
      deviceNameOrNumber: 'Device Name or Code',
      manualAdd: 'Manual Create',
      addByNumber: 'Create By Code',
      addByServer: 'Create By Server',
      addDevice: 'Create Device',
      createDevice: 'Create Device',
      configureDevice: 'Configure Device',
      configurationComplete: 'Configuration Complete',
      enterDeviceNumber: 'Enter Device Code',
      deviceNumberAvailable: 'Device Code Available',
      finish: 'Finish',
      onlineStatus: 'Online Status',
      alarmStatus: 'Alert',
      accessServiceProtocol: 'Service Protocol',
      alarmOption: 'Alert',
      noAlarmOption: 'No Alert',
      step1Title: 'Create Device',
      tips: 'Enter device code to complete device creation',
      step1Desc: 'Create basic device information',
      step2Title: 'Configure Device',
      step2Desc: 'Configure device according to the connection parameters provided by the system',
      step3Title: 'Configuration Complete',
      step3Desc: 'Complete device creation if device configuration is done',
      serverStep1Title: 'Select Service',
      serverStep1Desc: 'This is a very long description text',
      serverStep2Title: 'Configure Service',
      serverStep2Desc: 'This is a very long description text',
      ...
      success: 'Success',
      deviceConfigSuccess: 'Device Created Successfully',
      close: 'Close',
      fail: 'Failed',
      deviceConfigFail: 'Device configuration encountered problems, please try again',
      back: 'Back'
    },
    grouping_details: {
      messageId: 'messageId',
